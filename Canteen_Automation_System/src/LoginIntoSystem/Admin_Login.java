...
import CanteenAutomationSystem.Admin_Dynamical_menu;
...
public class Admin_Login extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Admin_username, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       PreparedStatement ps = con.prepareStatement("SELECT PASSWORD FROM `admin` WHERE `USERNAME`='"+Admin_username.getText()+"'");
       ResultSet rs = ps.executeQuery();
       if(rs.next()) {
           if(rs.getString(1).equals(Admin_password.getText())) {
               Admin_Dynamical_menu adm= new Admin_Dynamical_menu();
               adm.setVisible(true);
